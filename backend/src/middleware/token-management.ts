...
import {JWT_EXPIRATION, JWT_SECRET, REFRESH_EXPIRATION,} from "../config/env.js";
...
export function verifyTokenOptional(req: Express.Request, res: Response, next: NextFunction)
{
    const token = req.cookies?.access_token;
    ...
    if (token)
    {
        ...
        {
            // Token invalide, req.user stay undefined
        }
    }
